...
*Generated by Orchestra Project Manager*
    `;

    const planIssueUrl = await vcs.createIssue(planTitle, projectPlanBody, ['orchestra-project-plan', 'orchestra']);
...
*Generated by Orchestra Project Manager*
    ...
    await vcs.createIssue(task, issueBody, ['orchestra-task', 'todo']);
